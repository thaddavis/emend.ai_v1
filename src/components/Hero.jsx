      ...
      <Container className="relative">
        <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
          ...
          <div className="mt-6 space-y-6 font-display text-2xl tracking-tight text-blue-900">
            <p>
              The next generation of humans will use A.I. to have unprecedented insight into their environment.
              Emend.ai is here to give you a glimpse into this future.
            </p>
            <p>
              Enter the app to experience environmental insight like never before.
            </p>
          </div>
